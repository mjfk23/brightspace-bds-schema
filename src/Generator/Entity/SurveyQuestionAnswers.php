...
use Brightspace\Bds\Schema\Generator\Repository\SurveyQuestionAnswersRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Doctrine\ORM\Mapping\UniqueConstraint;

/**
 * The Survey Question Answers Brightspace Data Set returns possible answers for a given survey. Rows in the data set
 * are filtered out if they are associated with deleted survey questions.
 *
 * @see https://community.d2l.com/brightspace/kb/articles/4538-surveys-data-sets#survey-question-answers
 */
#[ORM\Entity(repositoryClass: SurveyQuestionAnswersRepository::class)]
#[ORM\Table(name: 'D2L_SURVEY_QUESTION_ANSWER')]
#[UniqueConstraint(name: 'D2L_SURVEY_QUESTION_ANSWER_PUK', columns: ['AnswerId', 'QuestionId', 'QuestionVersionId', 'SurveyObjectId'])]
final class SurveyQuestionAnswers
{
    #[ORM\Id]
     ...
     */
    #[ORM\Column(name: 'SurveyObjectId', type: Types::BIGINT, precision: 20, nullable: false)]
    private ?string $surveyObjectId = null;
    ...
    public function getSurveyObjectId(): ?string
    {
        return $this->surveyObjectId;
    }

    public function setSurveyObjectId(string $surveyObjectId): static
    {
